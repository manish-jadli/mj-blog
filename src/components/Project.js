...
export default function Project(){
    ...
    useEffect(()=>{
        sanityClient.fetch(`*[_title=="project"]{
            title,
            date,
            place,
            description,
    ...
    return(
       <main className="bg-green-100 min-h-screen p-12">
           <section className="container mx-auto">
                ...
                <h2 className="text-lg text-gray-600 flex justify-cener mb-12">Welcome to my projects page!</h2>
                <section className="grid grid-cols-2 gap-8">
                    ...
                    <article className="relative rounded-lg shadow-xl bg-white p-16">
                        ...
                        <div className="text-gray-500 text-xs space-x-4">
                            <span><strong className="font-bold">Finished on</strong>:{" "} {new Data(project.date).toLocaleDateString()}</span>
                            ...
                            <a href={project.link} rel="noopener noreferrer" target="_blank" className="text-red-500 font-bold hover:underline hover:text-red-400">
                                View The Project {" "}  <span role="img" aria-label="right pointer"> OK</span>
                                </a>
                        </div>
                    </article>
                    ))}
